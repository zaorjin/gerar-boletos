...
const Sicredi = require('gerar-boletos/lib/boleto/bancos/sicredi');
	...
	GeradorDeBoleto.prototype.gerarPDF = function(args) {
		return new Promise((resolve)=> {
			...
			boletos.forEach(function escreveOsDadosDoBoleto(boleto, indice) {
				...
				pdf.font('normal')
					.fontSize(args.tamanhoDaFonteDoTitulo)
					.text('Código de Baixa', args.ajusteX + 380, args.ajusteY + tituloDaSetimaLinha + 140, {
						lineBreak: false,
						width: 294,
						align: 'left'
					});
				...
				pdf.font('normal')
					.fontSize(args.tamanhoDaFonte)
					.text(banco.getNossoNumeroECodigoDocumento(boleto), args.ajusteX + 390, args.ajusteY + tituloDaSetimaLinha + 150, {
						lineBreak: false,
						width: 294,
						align: 'left'
					});	
